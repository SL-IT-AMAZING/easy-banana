...
import { base64Decode, base64Encode } from "@easybanana/util/encode"
import { Avatar } from "@easybanana/ui/avatar"
...
import { Collapsible } from "@easybanana/ui/collapsible"
import { DiffChanges } from "@easybanana/ui/diff-changes"
import { Spinner } from "@easybanana/ui/spinner"
import { Mark } from "@easybanana/ui/logo"
import { getFilename } from "@easybanana/util/path"
import { DropdownMenu } from "@easybanana/ui/dropdown-menu"
import { Session } from "@easybanana/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@easybanana/ui/toast"
...
import { useTheme, type ColorScheme } from "@easybanana/ui/theme"
    ...
    async function pollUpdate() {
      ...
      if (updateAvailable && toastId === undefined) {
        toastId = showToast({
          ...
          description: `A new version of Easy Banana (${version}) is now available to install.`,
          actions: [
            {
            ...
            <Match when={providers.all().length > 0 && !providers.paid().length && expanded()}>
              <div class="rounded-md bg-background-stronger shadow-xs-border-base">
                <div class="p-3 flex flex-col gap-2">
                  ...
                  <div class="text-text-base">Easy Banana includes free models so you can start immediately.</div>
